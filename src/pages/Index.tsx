...
const Index = () => {
  ...
  const portfolio = [
    ...
    {
      title: "Сайт для компании \"APARTMENT DAILY\"",
      description: "Сайт разработан в пределах отчета по ПиДИС.",
      points: ["Сайт онлайн аренды квартир", "Взаимодействие с БД", "Возможность регистрации/авторизации"],
      image: "https://cdn.poehali.dev/files/ca2962d7-e468-405a-a782-7a470af70f06.png"
    }
  ];
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <a href="tel:+79156264411" className="flex items-center gap-3 text-lg hover:text-purple transition-colors">+79115262411</a>
